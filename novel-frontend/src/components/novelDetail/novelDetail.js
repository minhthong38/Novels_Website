...
import { novels, categories } from '../../data/data';  // Adjust the import path as needed
...
export default function NovelDetail() {
  ...
  const categoryName = categories.find(category => category.id === novel.CategoryID)?.name;
              ...
              <div className="flex-1 flex flex-col items-center md:items-start md:ml-6">
                ...
                <div className="flex items-center mt-2">
                  <Link to="/authors" className="flex items-center">
                    ...
                    <span className="ml-2 underline text-lg">Rosie Nguyễn</span>
                  </Link>
